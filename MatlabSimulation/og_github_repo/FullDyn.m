...
T1 = T(1) + GravityCompT1(p.d1,p.d2,p.g,p.l1,p.m1,p.m2,th1,th2,thdot1,thdot2);
T2 = T(2) + GravityCompT2(p.d2,p.g,p.l1,p.m2,th1,th2,thdot1);

disp("gravity comp " + (GravityCompT1(p.d1,p.d2,p.g,p.l1,p.m1,p.m2,th1,th2,thdot1,thdot2)) + " " + (GravityCompT2(p.d2,p.g,p.l1,p.m2,th1,th2,thdot1)));
exit
